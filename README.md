...
| 📜 Première version | [index.html](https://nttsuong1302.github.io/dba-presentation/) | Première version de la présentation |
...
- `index.html` — la première version de la présentation
